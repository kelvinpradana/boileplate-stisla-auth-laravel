    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group form-role">
                    <label>diklat</label>
                    <select class="form-control" name="diklat_id" id="diklat_edit">
                        @foreach($diklats as $diklat)
                        <option value="{{ $diklat->id }}" > {{ $diklat->nama }}</option>
                        @endforeach
                    </select>
...
@section('bottom-script')
    ...
    <script type="text/javascript">
        ...
        function GetData(){
            $('#table-data').DataTable({
                ...
                columns: [
                    ...
                    {data: 'diklats', name: 'nama', "width": "20%"},
        ...
        function Edit(object){
            ...
            var url = "{{ route('pelatihan.edit', ':id') }}";
            ...
            $.ajax({
                ...
                success(result){
                    ...
                    $('#diklat_edit').val(data.diklat_id).change()
                }
            });
        }
        ...
        function UpdateData(){
            ...
            var id = $('#idEdit').val();
            var url = "{{ route('pelatihan.update', ':id') }}"
            url = url.replace(':id',id);
