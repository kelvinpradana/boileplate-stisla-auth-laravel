...
<div class="banner-carousel banner-carousel-1 mb-0">
  <div class="banner-carousel-item" style="background-image:url('{{ asset('constra/images/slider-main/bg1.jpg') }}')">
  ...
  <div class="banner-carousel-item" style="background-image:url('{{ asset('constra/images/slider-main/bg2.jpg') }}')">
  ...
  <div class="banner-carousel-item" style="background-image:url('{{ asset('constra/images/slider-main/bg3.jpg') }}')">
        ...
        <div class="row align-items-center">
          <div class="col-md-8 text-center text-md-left">
              <div class="call-to-action-text">
                <h3 class="action-title">Pengumuman pelatihan 2021 segera di mulai</h3>
              </div>
          </div><!-- Col end -->
