        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="pengumuman" id=pengumuman"" cols="30" rows="10"></textarea>
                    <!-- <input type="text" class="form-control" name="pengumuman" id="pengumuman" placeholder="pengumuman" autocomplete="off"> -->
                </div>
            </div>
        ...
        function GetData(){
            $('#table-data').DataTable({
                ...
                columns: [
                    ...
                    {data: 'pengumuman', name: 'pengumuman', "width": "20%"},
